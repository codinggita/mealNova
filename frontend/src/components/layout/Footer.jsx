      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <Link to="/" className="text-2xl font-bold text-orange-500 mb-4 inline-block">
              MealNova
            </Link>
            <p className="text-gray-400 text-sm">
              Your ultimate meal planning and discovery companion. Eat healthy, save time.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/meals" className="text-gray-400 hover:text-orange-500 transition-colors">Meals</Link></li>
              <li><Link to="/planner" className="text-gray-400 hover:text-orange-500 transition-colors">Planner</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/cookie" className="text-gray-400 hover:text-orange-500 transition-colors">Cookie Policy</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mb-4">
              Subscribe for weekly meal plans and tips.
            </p>
            <form className="flex">
              <input 
                type="email" 
              ...
              <button 
                type="submit" 
                className="bg-orange-600 px-4 py-2 rounded-r-md hover:bg-orange-700 transition-colors font-medium"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm text-center md:text-left">
            &copy; {new Date().getFullYear()} MealNova. All rights reserved.
          </p>
